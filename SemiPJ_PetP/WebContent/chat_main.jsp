	    ...
	    $('#chatContent').val('');  //전송후 지우기
         ...
         function addChat(chatName, chatContent, regdate){
        	 ...
        	 $('#chatList').append('<div class="row">' +
                     ...
                     '<img class="media-object img-circle" src="images/ano.png" alt="">' +  //사진
                     '</a>' +
           ...
           <div class="col-xs-12">
             ...
             <div class="portlet-heading" id="room">
               <div class="portlet-title">
                 <h4><i class="fa fa-circle text-white" >펫톡</i></h4>
               </div>
                ...
                <div class="portlet-footer">
                    <div class="row">
                     ...
                     <div class="form-group col-xs-2">
                         <button id="send" style="height: 30px;"  type="button" class="btn btn-default pull-right" onclick="submitFunction();">전송</button>
                            <div class="clearfix"></div>                                              
                     </div>
                  </div>
                </div>
