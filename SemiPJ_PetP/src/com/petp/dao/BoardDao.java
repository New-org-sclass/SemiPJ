...
public interface BoardDao {
	...
	String selectOneSql = " SELECT * FROM BOARD WHERE GROUP_NO=?" + 
							" ORDER BY BOARD_REGDATE DESC, GROUP_SQ ";
	String insertSql = " INSERT INTO BOARD VALUES(BOARDNOSQ.NEXTVAL,GROUPNOSQ.NEXTVAL,2,0,NULL,?,NULL,NULL,SYSDATE) ";
	...
	public List<BoardDto> selectOne(Connection con, int board_no);
